...
static std::array<std::array<uint64_t, 4>, 33> NEG_POWERS_OF_2 = {
    {// v18
     ...
     {{static_cast<uint64_t>(-4), 0x2710000000000000LL, 0x0000000000000000LL,
       0x0000000000000001LL}},  // ***
     // 6: 2^-(2^5) =   2^-32 =   2.3283064365386962890625E-10 =
     ...
     {{static_cast<uint64_t>(-19728), 0x7fc6447bee60ea43LL,
       0x2548da5c8b125b27LL, 0x5f42d1142f41d349LL}},  // ***
     // 18: 2^-(2^17) =   2^-131072 =
     ...
     {{static_cast<uint64_t>(-39456), 0x3fc65180f88af8fbLL,
       0x6a6915f383349413LL, 0x063c3708b6ceb291LL}},  // ***
     // 19: 2^-(2^18) =   2^-262144 =
     ...
     {{static_cast<uint64_t>(-157826), 0x629963a25b8b2d79LL,
       0xd00b9d2286f70876LL, 0xe97004700c3644fcLL}},  // ***
     // 21: 2^-(2^20) =   2^-1048576 =
     ...
     {{static_cast<uint64_t>(-1262611), 0x7bf795d276c12f66LL,
       0x66a61d62a446659aLL, 0xa1a4d73bebf093d5LL}},  // ***
     // 24: 2^-(2^23) =   2^-8388608 =
     ...
     {{static_cast<uint64_t>(-2525222), 0x3c07d96ab1ed7799LL,
       0xcb7355c22cc05ac0LL, 0x4ffc0ab73b1f6a49LL}},  // ***
     ...
     {{static_cast<uint64_t>(-5050445), 0x8cc4cd8c3edefb9aLL,
       0x6c8ff86a90a97e0cLL, 0x166cfddbf98b71bfLL}},  // ***
     ...
     {{static_cast<uint64_t>(-10100890), 0x4d67d81cc88e1228LL,
       0x1d7cfb06666b79b3LL, 0x7b916728aaa4e70dLL}},  // ***
     ...
     {{static_cast<uint64_t>(-20201781), 0xea0c55494e7a552dLL,
       0xb88cb9484bb86c61LL, 0x8d44893c610bb7dFLL}},  // ***
     ...
     //      {-161614248, 0x7cf5_1edd_8a15_f1c9L, 0x656d_ab34_98f8_e697L,
...
void QuadrupleBuilder::findBinaryMantissa(int32_t exp10, double exp2,
                                          std::array<uint64_t, 6>& mantissa) {
...
void QuadrupleBuilder::multPacked3x64_AndAdjustExponent(
    std::array<uint64_t, 4>& factor1, std::array<uint64_t, 4>& factor2,
...
void QuadrupleBuilder::multUnpacked6x32byPacked(
    std::array<uint64_t, 6>& factor1, std::array<uint64_t, 4>& factor2,
    std::array<uint64_t, 12>& product) {
...
template <std::size_t N>
void QuadrupleBuilder::addToBuff(std::array<uint64_t, N>& buff, int32_t idx,
                                 uint64_t summand) {
  int32_t maxIdx = idx;
