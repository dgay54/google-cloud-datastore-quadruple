...
#ifndef THIRD_PARTY_CPP_QUADRUPLE_QUADRUPLE_BUILDER_H_
#define THIRD_PARTY_CPP_QUADRUPLE_QUADRUPLE_BUILDER_H_
#define CLOUD_DATASTORE_UTIL_QUADRUPLE_BUILDER \
  THIRD_PARTY_CPP_QUADRUPLE_QUADRUPLE_BUILDER_H_  // upstream guard
...
class QuadrupleBuilder {
 ...
 private:
  ...
  void findBinaryMantissa(int32_t exp10, double exp2,
                          std::array<uint64_t, 6>& mantissa);
